...
################################################################################
#
# Date/Beginn :    21.07.2016/15.08.2015
#
# Version     :    V2.00
#
# Milestones  :    V2.00 (jul 2016) -> takeover for can_lin_env.git
#                                      cleanups/removes
...
my_usage()
{
    ...
    echo "| REPO: lin       -> lin kernel driver                   |"
    echo "|                                                        |"
...
set_repo_names()
{
    ...
    lin="://rtime.felk.cvut.cz/linux-lin.git"

    # array with all available repos
    repo_names_array[0]=${can_utils}
    repo_names_array[1]=${jailhouse}
    repo_names_array[1]=${lin}
}
